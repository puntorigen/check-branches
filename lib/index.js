(function (global, factory) {
    ...
    **/
    ...
    new open_console();
    //
    var check_branches = /** @class */ (function () {
        function check_branches(arg) {
            if (arg === void 0) { arg = { silent: true, workdir: process.cwd() }; }
            this.workdir = arg.workdir;
            this.silent = arg.silent;
        }
        check_branches.prototype.getCurrentBranch = function () {
            return __awaiter(this, void 0, void 0, function () {
                var resp;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, branch(this.workdir)];
                        case 1:
                            resp = _a.sent();
        ...
        check_branches.prototype.check = function (branch) {
        ...
        check_branches.prototype.install = function (arg) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    console.log('');
                    return [2 /*return*/];
